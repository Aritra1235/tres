import { TextInput, StyleSheet, KeyboardAvoidingView, Platform, Button, TouchableOpacity, Alert } from "react-native";
...
export default function Index() {
    ...
    async function handleLogin() {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setErrorMessage(response.status === 401 ? 'Invalid username or password' : 'Login failed');
                setIsError(true);
            }
        } catch (error) {
  ...
  return (
    ...
    >
      ...
      <ThemedText style={styles.instructions}>Please Log In with your JellyFin User Account</ThemedText>
      </ThemedView>
